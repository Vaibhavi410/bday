      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Athay</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Twins's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Happy Birthday! 🎉 Don’t worry about getting older… you’re still younger than you’ll be next year 😌 💗</p>
        </section>
